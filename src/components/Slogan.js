    ...
    return (
        <div className="slogan-align">
            ...
            <div className="slogan">
                <a rel="noopener noreferrer" className="link-contact" href={"https://drive.google.com/file/d/1mQVWU_eqmBXeopVZ8EUZGYwOMFyT4K2Y/view"} target="_blank"><h1 className="name">JEAN-FRANCOIS SEBAGH TEST</h1></a>
